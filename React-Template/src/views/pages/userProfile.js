                           ...
                           <CardBody>
                              <div className="mb-3">
                                 ...
                                 <span className="display-block overflow-hidden">
                                    Hi, I’m Jose, I’m 29 and I work as a Ninja Developer for the “SONATA-SOFTWARE” Creative Studio.
                                 ...
                                 <Col sm="12" xs="12" md="6" lg="6">
                                    <ul className="no-list-style">
                                       <li className="mb-2">
                                          ...
                                          <span className="line-height-2 display-block overflow-hidden">
                                             Ninja Developer for the “SONATA-SOFTWARE” creative studio.
                                          </span>
                                       </li>
                                       <li className="mb-2">
                                          <span className="primary text-bold-500">
                                          ...
                                          <span className="line-height-2 display-block overflow-hidden">
                                             Senior Ninja Developer for the “SONATA-SOFTWARE” creative studio.
                                          </span>
                                       </li>
                                    </ul>
                                 </Col>
