                     ...
                     <div className="error-footer bg-transparent">
                        <Row>
                           <p className="text-muted text-center col-12 py-1">
                              © 2018 <Link to="/pages/error">SONATA-SOFTWARE </Link>
                              Crafted by <i className="ft-heart font-small-3" />
                              
                              <a
                                 href="https://SONATA-SOFTWARE.com/demo/SONATA-SOFTWARE-react-redux-bootstrap-admin-dashboard-template/landing-page/"
