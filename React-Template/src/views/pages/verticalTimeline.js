...
import { Row, Col, Form, FormGroup, Input, Card, CardHeader,CardTitle, CardBody, CardFooter, Button } from "reactstrap";
...
import VlTimeline from "./example-source/verticalTimeline";
            ...
            <Card>
               <CardBody>
                        ...
                        <Col md="12" className="leftDiv">
                           <div className="installation-steps">
                              ...
                              <div className="installation-box">
                                 <div>npm install react-router-dom</div>
                  ...
                  <Col md="12" lg="6" className="rightDiv">
                        <CopyToClipboard text={VlTimeline}
