               ...
               <Form action="#">
                  <FormGroup className="position-relative has-icon-right mb-0">
                     <Input
                        ...
                        id="iconLeft"
                        placeholder="SONATA-SOFTWARE Admin Template"
                     />
            ...
            <div id="search-results">
               <Row>
                           ...
                           <div className="media-body">
                              <p className="lead mb-0">
                                <Link to="/pages/search">
                                    <span className="text-bold-600">SONATA-SOFTWARE</span>- Responsive React 16 Admin Template
                                 </Link>
                              </p>
                              <p className="mb-0">
                                <Link to="/pages/search" className="teal darken-1">
                                    https://SONATA-SOFTWARE.com/
                                    <span className="text-bold-600">SONATA-SOFTWARE</span>/<i aria-hidden="true" />
                                 </Link>
                              </p>
                              ...
                              <p>
                                 ...
                                 <span className="text-bold-600">SONATA-SOFTWARE</span>
                        ...
                        <li className="media">
                           ...
                           <div className="media-body media-search">
                              ...
                              <p>
                                 ...
                                 <span className="text-bold-600">SONATA-SOFTWARE Admin</span>
                  ...
                  <Col lg="4">
                     <Card className="card">
                        <div className="px-0">
                           <h4 className="card-title">SONATA-SOFTWARE</h4>
                        ...
                        <div className="px-0">
                           ...
                           <ul className="list-group mb-2">
                              <li className="list-group-item">
                                 ...
                                 <Link to="/pages/search" className="card-link">https://SONATA-SOFTWARE.com/</Link>
                              </li>
                              <li className="list-group-item">
                                 <strong>Customer service :</strong> 022 8888 9999
                              </li>
                              <li className="list-group-item">
                                 <strong>Founder :</strong> SONATA-SOFTWARE
                              </li>
                              <li className="list-group-item">
                              ...
                              <li className="list-group-item">
                                 ...
                                 <Link to="/pages/search">support@SONATA-SOFTWARE.com</Link>
                              </li>
                           </ul>
